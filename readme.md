...
Translation management for your Laravel application (fork with support for laravel 8 & PHP 8).
...
Laravel Translation is a package for Laravel 8 which allows you full control
